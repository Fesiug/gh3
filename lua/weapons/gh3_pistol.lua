...
-- View
SWEP.ViewModel			= Model( "models/gh3/fp/automag lite.mdl" )
...
if CLIENT then
	...
	SWEP.WepSelect = Material("gh3/ui/schematics/po2/pistol.png", "mips smooth")
	--SWEP.VMOffset = Vector(0, 6, 1.5)
	SWEP.VMOffset = Vector(0, 3, 0.75)
end